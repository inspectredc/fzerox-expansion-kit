...
s32 func_80704120(LEODiskID arg0) {
    s32 i;

    if (arg0.company[0] != D_8079F9C4[0]) {
        return 1;
    }
    if (arg0.company[1] != D_8079F9C4[1]) {
        return 1;
    }

    if (arg0.gameName[0] < D_8079F9C8[0]) {
        return 1;
    }

    for (i = 1; i < ARRAY_COUNT(arg0.gameName); i++) {
        if (D_8079F9C8[i] != arg0.gameName[i]) {
            return 1;
        }
    }
    return 2;
...
s32 func_807041C0(LEODiskID arg0) {
    s32 i;
...
#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/D_80773A30.s")
...
bool func_80704F44(LEODiskID arg0, LEODiskID arg1) {
    s32 i;
    s32* var_v0 = (s32*) &arg0;
    s32* var_v1 = (s32*) &arg1;
...
s32 func_80704FF4(LEODiskID* arg0) {
    while (true) {
...
#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_80705310.s")

#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_80705554.s")
...
#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_80706100.s")

#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_80706308.s")
...
void func_80706518(s32 arg0, s32 arg1, s32 arg2) {
    ...
    for (D_8079F9CC = 0; D_8079F9CC < D_391 - D_34E; D_8079F9CC++) {
        osWritebackDCacheAll();
        func_80705310(&D_8079F958, 0, (u32)D_34E + D_8079F9CC, D_8077B4D0, 1, &gDmaMesgQueue);
        osRecvMesg(&gDmaMesgQueue, NULL, 1);
        osWritebackDCacheAll();
        func_80705310(&D_8079F958, 1, 0xBF6 + D_8079F9CC, D_8077B4D0, 1, &gDmaMesgQueue);
        osRecvMesg(&gDmaMesgQueue, NULL, 1);
    }
    osWritebackDCacheAll();
    func_80707204();
...
#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_8070664C.s")

#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_8070687C.s")

#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_80706B84.s")

#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_80706E94.s")

#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_80707198.s")
...
#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_807073A0.s")
...
#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_80707E58.s")
...
void func_80708058(u8* arg0, u8* arg1, size_t arg2) {
    OSMesg sp1C[7];

    D_8079A308.hdr.pri = 0;
    D_8079A308.hdr.retQueue = &gDmaMesgQueue;
    D_8079A308.dramAddr = osPhysicalToVirtual(arg1);
    D_8079A308.devAddr = arg0;
    D_8079A308.size = arg2;
    gCartRomHandle->transferInfo.cmdType = LEO_CMD_TYPE_2;
    func_80768B88(gCartRomHandle, &D_8079A308, 0);
    osRecvMesg(&gDmaMesgQueue, sp1C, OS_MESG_BLOCK);
}

#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_807080E8.s")

void func_8070818C(u8* arg0, u8* arg1, size_t arg2) {
    s32 temp_a2;
    s32 i;
    s32 temp_s3;
    ...
    temp_s3 = arg2 >> 0xA;
    for (i = 0; i < temp_s3; i++) {
        func_80708058(arg0, arg1, 0x400);
        arg0 += 0x400;
        arg1 += 0x400;
    }
    temp_a2 = arg2 & 0x3FF;
    if (temp_a2 != 0) {
        func_80708058(arg0, arg1, temp_a2);
    }
}

#pragma GLOBAL_ASM("asm/jp/nonmatchings/11850/func_80708218.s")
