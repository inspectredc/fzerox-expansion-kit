...
void func_xk2_800EACB0(void) {
    ...
    if ((Course_CalculateChecksum() != COURSE_CONTEXT()->courseData.checksum) || (COURSE_CONTEXT()->courseData.creatorId != CREATOR_NINTENDO) || ((s8)(COURSE_CONTEXT()->courseData.fileName[0x16]) >= 0xE)) {
...
s32 func_xk2_800EAF24(s32 arg0) {
    D_80794E10 = 0;
    D_xk2_800F7400 = 0;
    func_80768574(0xFFFB, arg0, &D_xk1_8003A5D8[D_xk2_80119884].unk_1D, &D_xk2_800F7408, 0xC830);
    Leo_strcpy(&D_80030060, arg0);
    return 0;
}

s32 func_xk2_800EAFA8(s32 arg0) {
    D_80794E10 = 0;
    D_xk2_800F7400 = 0;
    func_80768574(0xFFFB, arg0, &D_xk1_8003A5D8[D_xk2_80119884].unk_1D, &D_xk2_800F7408, 0xC830);
    return 0;
...
void func_xk2_800EB018(void) {
    ...
    if ((D_xk1_80032BF8 != 0) && (D_xk2_800F7400 == 1)) {
        D_xk1_80032BF8 = 0;
        D_xk2_800F7400 = 0xFF;
        if ((func_xk1_8002BFA4(&D_xk2_800F7400) == 0) && (D_80119880 != 1)) {
            D_xk1_80030610 = -1;
            D_xk1_80030678 = -1;
            D_800D6CA0.unk_08 = 0;
            return;
...
#pragma GLOBAL_ASM("asm/jp/nonmatchings/overlays/course_edit/19C470/func_xk2_800EB400.s")

#pragma GLOBAL_ASM("asm/jp/nonmatchings/overlays/course_edit/19C470/func_xk2_800EB938.s")
