...
u16 D_i2_800D11F2;
s16 D_i2_800D11F4;
unk_8010D778 D_i2_800D11F8;
s16 D_i2_800D1228;
s16 D_i2_800D122A;
u16* D_i2_800D122C;
u16 D_i2_800D1230[32];

s16 D_i2_800BEE10 = 1;
s32 D_800BEE14 = 0;
s16 D_i2_800BEE18[] = { -75, -74, -73, -1, 1, 73, 74, 75 };
...
s32 D_i2_800BEE34[] = { 7, 3, 3, 1, 1, 0, 0, 0 };

void func_i2_800A20A0(void) {
    unk_8010D778* var = &D_i2_800D11F8;
...
void func_i2_800A20EC(void) {
    ...
    if (D_8076C810 == 31) {
        func_i2_800A250C(0, 10);
        return;
    }

    switch (gGameMode) {
        case GAMEMODE_FLX_TITLE:
            func_i2_800A250C(0, 7);
            break;
        case GAMEMODE_GP_END_CS:
            func_i2_800A26C0(5, 120);
            func_i2_800A250C(0, 5);
            break;
        case GAMEMODE_COURSE_EDIT:
            func_i2_800A250C(0, 10);
            break;
        case GAMEMODE_CREATE_MACHINE:
            func_i2_800A250C(0, 6);
            break;
        case GAMEMODE_FLX_COURSE_SELECT:
            func_i2_800A26C0(5, 40);
            func_i2_800A250C(0, 5);
            break;
...
void func_i2_800A231C(void) {
    ...
    if (D_8076C810 == 33) {
        func_i2_800A250C(1, 10);
        return;
    }

    switch (gQueuedGameMode) {
        case GAMEMODE_FLX_TITLE:
            func_i2_800A250C(1, 1);
            break;
        case GAMEMODE_GP_END_CS:
            func_i2_800A250C(1, 5);
            break;
        case GAMEMODE_GP_RACE:
        case GAMEMODE_PRACTICE:
        case GAMEMODE_VS_2P:
        ...
        case GAMEMODE_FLX_OPTIONS_MENU:
            if (D_8076C810 == 23) {
                func_i2_800A26C0(9, 2);
                func_i2_800A250C(1, 9);
                break;
            }
            func_i2_800A26D4(1, 1);
            break;
        case GAMEMODE_FLX_MAIN_MENU:
            if (D_8076C810 == 23) {
                func_i2_800A26C0(9, 3);
                func_i2_800A250C(1, 9);
                break;
            }
            func_i2_800A250C(1, 7);
            break;
        case GAMEMODE_RECORDS:
            if (D_8076C810 != 23) {
                func_i2_800A26D4(1, 1);
...
s32 func_i2_800A250C(s32 arg0, s32 arg1) {
    u32 var_a1;
    u32 var_a2;
    unk_8010D778* var = &D_i2_800D11F8;
    ...
    var->unk_04 = arg1;
    var->unk_10 = arg0;
    if (var->unk_04 != D_i2_800D122A) {
        var->unk_0E = 0;
    } else {
        var->unk_0E = D_i2_800D1228;
        D_i2_800D122A = 0;
        D_i2_800D1228 = 0;
    }
    D_i2_800D122C = NULL;
    ...
    if (((var->unk_14 = func_807084E4(2, var_a1)) == NULL) || ((var->unk_18 = func_807084E4(2, var_a2)) == NULL)) {
        var->unk_04 = 5;
        return 1;
    }
    if (var->unk_04 == 8) {
        D_i2_800D122C = D_i2_800D1230;
    }
    return 0;
}

void func_i2_800A26C0(s32 arg0, s32 arg1) {
    D_i2_800D122A = arg0;
    D_i2_800D1228 = arg1;
}

const s32 D_i2_800C1A40[] = { 1, 2, 3, 4, 5, 6, 7 };

s32 func_i2_800A26D4(s32 arg0, s32 arg1) {
    s32 temp;
    u32 temp2;
    s32 var_v0;
    ...
    if (arg0 == 0) {
        ...
        if (arg1 != 0) {
            if (temp < 2) {
                temp2 = Math_Rand1();
                var_v0 = func_i2_800A250C(arg0, D_i2_800C1A40[temp2 % 7]);
            } else {
                var_v0 = func_i2_800A250C(arg0, 10);
            }
        } else {
            temp2 = Math_Rand1();
            var_v0 = func_i2_800A250C(arg0, D_i2_800C1A40[temp2 % 7]);
...
s32 func_i2_800A27C4(void) {
    ...
    switch (var->unk_00) {
        case 0:
            break;
        case 1:
            func_i2_800A2F14(var);
            break;
        case 2:
            func_i2_800A35B8(var);
            break;
        case 3:
            func_i2_800A3E6C(var);
            break;
        case 4:
            func_i2_800A4C0C(var);
            break;
        case 5:
        case 6:
            func_i2_800A515C(var);
            break;
        case 9:
            func_i2_800A53BC(var);
            break;
        case 7:
            func_i2_800A5634(var);
            break;
        case 8:
            func_i2_800A5BD0(var);
            break;
        case 10:
        default:
            break;
...
void func_i2_800A28D0(unk_8010D778* arg0) {
    ...
    switch (arg0->unk_00) {
        ...
        case 4:
            ...
            arg0->unk_08 = 1;
            func_i2_800A4860(arg0);
            break;
        case 5:
        case 6:
            if (arg0->unk_10 != 0) {
                arg0->unk_08 = 3;
                func_i2_800A5130(arg0, 255, 20);
            } else {
                arg0->unk_08 = 1;
                func_i2_800A5130(arg0, 0, 20);
            }
            break;
        case 9:
            if (arg0->unk_10 == 0) {
...
Gfx* func_i2_800A2B0C(Gfx* gfx) {
    ...
    switch (var->unk_00) {
        case 1:
            gfx = func_i2_800A3350(gfx, var);
            break;
        case 2:
            gfx = func_i2_800A380C(gfx, var);
            break;
        case 3:
            gfx = func_i2_800A44B4(gfx, var);
            break;
        case 4:
            gfx = func_i2_800A44B4(gfx, var);
            break;
        case 5:
        case 6:
            gfx = func_i2_800A52A4(gfx, var);
            break;
        case 9:
            gfx = func_i2_800A557C(gfx, var);
            break;
        case 7:
            gfx = func_i2_800A5874(gfx, var);
            break;
        case 8:
            gfx = func_i2_800A5CD4(gfx, var);
            break;
        case 10:
            break;
    }
...
void func_i2_800A2CCC(void) {
    ...
    if (var->unk_12 & 0x10) {
        func_80709DEC(var->unk_14, 0x20600);
    }
    if (var->unk_12 & 0x20) {
        func_8070E79C(var->unk_14, 0x20600);
    }
    if (var->unk_12 & 0x40) {
        func_8070EB90(var->unk_14, D_i2_800D122C, 0x20600);
    }
}

void func_i2_800A2E34(unk_8010D778* arg0) {
    s32 i;
    u8* ptr = arg0->unk_18;
    s32 temp;
    s32 temp2;
    ...
    for (i = 0; i < 5; i++) {
        temp = Math_Rand1() % 74;
        temp2 = Math_Rand1() % 56;
        func_i2_800A3300(arg0, (temp2 * 74) + temp, 1);
    }
}

void func_i2_800A2F14(unk_8010D778* arg0) {

    switch (arg0->unk_08) {
        case 1:
            if (func_i2_800A2FC0(arg0)) {
                arg0->unk_08 = 2;
                arg0->unk_0C = 0;
            }
            break;
...
bool func_i2_800A2FC0(unk_8010D778* arg0) {
    s32 temp_v0;
    bool var_a0;
    s32 var_a1;
    s8* var_v0;
    ...
    for (i = 0; i < 0x1030; i++) {
        if (func_i2_800A32C0(arg0, i) == 1) {
            temp_v0 = func_i2_800A31C8(arg0, i, sp40);
            if (temp_v0 == 0) {
                func_i2_800A3300(arg0, i, 2);
                continue;
            }

            if ((Math_Rand1() & D_i2_800BEE34[temp_v0 - 1])) {
                continue;
            }
            ...
            var_a1 = (D_i2_800BEE18[var_v1] % 2072) + i;
            if (var_a1 < 0) {
                var_a1 += 0x818;
            }
            func_i2_800A3300(arg0, var_a1, 1);
        }
    }
...
s32 func_i2_800A31C8(unk_8010D778* arg0, s32 arg1, s32* arg2) {
    s32 var_a1;
    s32 i;
    s32 var_s3 = 0;
    s16* var_s1 = D_i2_800BEE18;
    ...
    for (i = 0; i < 8; i++) {
        ...
        if (func_i2_800A32C0(arg0, var_a1) == 0) {
            var_s3++;
            arg2[i] = 1;
        } else {
            arg2[i] = 0;
...
s32 func_i2_800A32C0(unk_8010D778* arg0, s32 arg1) {
...
void func_i2_800A3300(unk_8010D778* arg0, s32 arg1, s8 arg2) {
    s8* temp_v0 = (s8*) arg0->unk_18 + (arg1 >> 1);
...
Gfx* func_i2_800A3350(Gfx* gfx, unk_8010D778* arg1) {
    s32 temp_v0;
    s32 var_s0;
    s32 j;
    s32 var_s2;
    ...
    for (i = 0; i < 0x38; i++) {
        ...
        for (j = 0; j < 0x4A; j++, var_s2++) {
            if (arg1->unk_10 != 0) {
                if (func_i2_800A32C0(arg1, var_s2) != 0) {
                    var_v1 = (var_s3 * 4);
                    temp_v0 = ((i * 4) + 8);
                    if (var_s0 == 0) {
                        continue;
...
void func_i2_800A3564(unk_8010D778* arg0) {
    s32 i;
    u8* var_v1;
...
void func_i2_800A35B8(unk_8010D778* arg0) {
    switch (arg0->unk_08) {
        case 0:
            break;
        case 1:
            if (func_i2_800A3620(arg0)) {
                arg0->unk_08 = 2;
            }
            break;
        case 2:
...
bool func_i2_800A3620(unk_8010D778* arg0) {
    bool ret;
    s32 i;
    s32 var_v0;
    s32 var_v1;
...
Gfx* func_i2_800A380C(Gfx* gfx, unk_8010D778* arg1) {
    s32 i;
    s32 j;
...
void func_i2_800A3AC4(unk_8010D778* arg0) {
    s32 pad[11];
    f32 sp104[4];
    f32 spF4[4];
    f32 spE4[4];
...
void func_i2_800A3E6C(unk_8010D778* arg0) {
    s32 i;
    s32 temp_v0;
    s32 var_s0;
...
bool func_i2_800A4078(unk_8010D778* arg0) {
    bool var_a0;
    s32 j;
    s32 i;
    s32 var_v1;
...
Gfx* func_i2_800A44B4(Gfx* gfx, unk_8010D778* arg1) {
    s32 pad[2];
    s32 i;
    s32 j;
    f32 var_fv0;
...
void func_i2_800A4860(unk_8010D778* arg0) {
    s32 i;
    s32 j;
    s32 k;
    s32 m;
...
void func_i2_800A4C0C(unk_8010D778* arg0) {
    s32 i;
    bool var_s0;
...
bool func_i2_800A4E1C(unk_8010D778* arg0) {
    bool var_a0;
    s32 i;
    s32 j;
    unk_8010D778_unk_1C* temp_v0;
...
void func_i2_800A5130(unk_8010D778* arg0, s32 arg1, s32 arg2) {
...
void func_i2_800A515C(unk_8010D778* arg0) {
    unk_8010D778_unk_1C* temp_v0;
...
Gfx* func_i2_800A52A4(Gfx* gfx, unk_8010D778* arg1) {
...
void func_i2_800A5350(unk_8010D778* arg0) {
    ...
    switch (arg0->unk_0E) {
        case 0:
        case 1:
            D_800D11F0 = arg0->unk_1C.unk_00;
            break;
        case 2:
        case 3:
            D_800D11F0 = arg0->unk_1C.unk_04;
            break;
    }
}

void func_i2_800A53BC(unk_8010D778* arg0) {
...
Gfx* func_i2_800A557C(Gfx* gfx, unk_8010D778* arg1) {

    gDPSetTextureLUT(gfx++, G_TT_NONE);

    return func_8070A99C(gfx, arg1->unk_14, arg1->unk_1C.unk_00, arg1->unk_1C.unk_04, 296, 224, G_IM_FMT_RGBA,
                         G_IM_SIZ_16b, 0, 0, 0, 0);
}

void func_i2_800A55F0(unk_8010D778* arg0) {
    s32 i;
    f32* var_v1;
...
void func_i2_800A5634(unk_8010D778* arg0) {

    switch (arg0->unk_08) {
        case 0:
            break;
        case 1:
            if (func_i2_800A56D4(arg0)) {
                arg0->unk_08 = 2;
                arg0->unk_0C = 0;
            }
            break;
...
bool func_i2_800A56D4(unk_8010D778* arg0) {
    f32 var_fv0;
    s32 var_a2;
    s32 var_a3;
    s32 i;
    ...
    for (i = 0, var_a1 = arg0->unk_18; i < 224; i++, var_a1++) {
        ...
        var_a2 = var - var_a2;
        var_a3 = (arg0->unk_0C * D_i2_800BEE30) - var_a2;
...
Gfx* func_i2_800A5874(Gfx* gfx, unk_8010D778* arg1) {
    f32* var_t3;
    u16* var_s5;
    s32 i;
    s32 j;
...
#else
#pragma GLOBAL_ASM("asm/jp/nonmatchings/overlays/ovl_i2/1039E0/func_i2_800A5874.s")
#endif

void func_i2_800A5BA8(unk_8010D778* arg0) {
    arg0->unk_12 |= 1;
    arg0->unk_12 |= 0x10;
    arg0->unk_12 |= 0x40;
...
void func_i2_800A5BD0(unk_8010D778* arg0) {

    switch (arg0->unk_08) {
        case 0:
            break;
        case 1:
            if (func_i2_800A5C70(arg0)) {
                arg0->unk_08 = 2;
                arg0->unk_0C = 0;
            }
            break;
...
bool func_i2_800A5C70(unk_8010D778* arg0) {
    bool var_v1 = false;

    if (arg0->unk_1C.unk_00 >= 0) {
        D_i2_800D1230[arg0->unk_1C.unk_00] = 0;
    }
    arg0->unk_0C++;
    if (arg0->unk_0C >= 2) {
        arg0->unk_0C = 0;
...
Gfx* func_i2_800A5CD4(Gfx* gfx, unk_8010D778* arg1) {
    return func_8070DEE0(gfx, arg1->unk_14, D_i2_800D122C, G_IM_FMT_CI, 1, 12, 8, 296, 224, 5);
}
