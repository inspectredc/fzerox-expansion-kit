...
Gfx* func_i3_8004D758(Gfx* gfx) {
    ...
    switch (D_i3_8006D594) {
        case 0:
            ...
            if (((gSavedGhostInfo.encodedCourseIndex != 0) && (gSavedGhostInfo.courseIndex == gCourseIndex) && (sFastestGhostTime >= gSavedGhostInfo.raceTime)) || (gCourseIndex >= COURSE_EDIT_1)) {
                var_t1 |= 1;
            }
            if ((sFastestGhostTime >= D_i3_8006D270[0].raceTime) && (sFastestGhostTime >= D_i3_8006D270[1].raceTime) && (sFastestGhostTime >= D_i3_8006D270[2].raceTime)) {
                var_t1 |= 2;
            }
            ...
            gfx = func_i3_DrawRaceMenuTexture(gfx, RACE_MENU_NO_GAME_PAK, 90, 55);
            ...
            gfx = func_i3_DrawRaceMenuTexture(gfx, RACE_MENU_NO_DISK, 90, 71);
...
extern s32 sPauseMenuScissorBoxTimer;
extern s32 sPauseMenuOptionIndex;
extern s32 sPausePlayerNum;
...
Gfx* func_i3_80051994(Gfx* gfx, s32 playerNum) {
    s32 i;
    s32 left;
    s32 top;
    s32 speed;
...
Gfx* func_i3_80053BF8(Gfx* gfx, s32 arg1) {
    ...
    if (gNumPlayers == 1) {
        if ((D_i3_8006D408[arg1] == 1) && (D_8076C7D8 == 0)) {
            func_8070DAFC();
        }
        if ((D_i3_8006D408[arg1] == 60) && (D_8076C7D8 == 0)) {
            func_8070DAD4(0x17);
        }
    }
...
extern const char* sCharacterNames[];
...
extern s32 D_i3_8006B538[][4];
extern s32 D_i3_8006B588[];
extern s32 D_i3_8006B598[];
extern s32 D_i3_8006B5A8[];
extern s32 D_i3_8006B5B8[];
extern s32 D_i3_8006D09C;
extern s32 D_i3_8006D4E8;
extern s32 D_i3_8006D4F0[];
extern s32 D_i3_8006D500[];
extern s32 D_i3_8006D510[];
extern s32 D_i3_8006D520[];
extern s32 D_i3_8006D540;
...
extern f32 D_i3_8006D4D8;
extern f32 D_i3_8006D4DC;
extern s32 gRacerIdsByPosition[];
...
Gfx* func_i3_8005823C(Gfx* gfx) {
    ...
    if (((gGameFrameCount % 120) == 0) && !gGamePaused) {
        ...
        if (D_8076C7D8 != 0) {
            ...
            if (((gNumPlayers == j) || (D_807A16CC == 1)) && (D_8076C7D8 == 1)) {
                D_8076C7D8 = 3;
            }
        }
    }
    if (gNumPlayers == 1) {
        if (((gPlayers[playerIndex].unk_04 == 4) || (gPlayers[playerIndex].unk_04 == 6)) && (D_i3_8006D3F8[0] == 0)) {
            ...
            if (gGameMode == GAMEMODE_GP_RACE) {
                ...
                if ((D_8076C7D8 == 0) && (gControllers[gPlayerControlPorts[0]].buttonPressed & BTN_L)) {
        ...
        if (gGameMode != GAMEMODE_PRACTICE) {
            if ((gRacers[playerIndex].lap == gTotalLapCount) && (D_8076C7D8 == 0) &&
            ...
            if ((gRacers[playerIndex].lap == 2) && (D_8076C7D8 == 0) && !gGamePaused &&
                ...
                if (D_i3_8006D374 >= 0x190) {
                    ...
                    if (D_i3_8006D0B0) {
                        ...
                        if (D_i3_8006D0B4 == 0) {
                            ...
                            D_i3_8006D0B4 = 1;
                            var_s1 = 1;
                            for (var_a0 = 0; var_a0 < 24; var_a0++) {
                                if (gCourseInfos[var_a0].timeRecord[0] >= func_i2_800A9788(var_a0)) {
                                    var_s1 = 0;
                                    break;
                                }
                            }
                            if ((gCurrentGhostType == 2) && (func_i2_800A9B88() == 0xFFF) && (var_s1 != 0)) {
                                D_8076C7C4 = 1;
                            }
                        }
                        i = func_i3_80065204();
        ...
        if (D_8006D544 == 0) {
            for (i = 0; i < gTotalRacers; i++) {
                ...
                if (i < gNumPlayers) {
                    ...
                    if ((racer->lap == 2) && (D_8076C7D8 == 0) && !gGamePaused) {
                ...
                if (((racer->stateFlags & RACER_STATE_FLAGS_2000000) && (i < gNumPlayers)) || (D_807A16CC == 1)) {
        ...
        if ((D_807A16CC == 1) && (D_8076C7D8 == 0)) {
            ...
            if ((D_i3_8006D4E8 == 0) && (D_8076C7D8 == 0)) {
                func_80741EC4();
            }
        } else {
            D_8006D544 = 0;
    ...
    if (D_8076C7D8 == 0) {
        if (gGamePaused) {
            ...
            sPauseMenuOptionIndex = 0;
            for (i = 0; i < gNumPlayers; i++) {
                if ((gControllers[gPlayerControlPorts[i]].buttonPressed & BTN_START) && (D_8076C7D8 == 0) &&
                    (D_807A16CC == 0) && (gRaceIntroTimer < 320)) {
