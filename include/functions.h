...
void func_806F9628(Mtx*, MtxF*, f32, f32, f32, f32, f32, f32, f32);
...
void func_807033A0(f32*, f32*, f32*);
...
void func_80711170(unk_800E51B8**);
void func_80711178(void);
unk_800E51B8* func_807112A0(s16, s16, s16, s16, s16, u16, u16, unk_800E51B8_unk_1C_func);
void func_807113DC(unk_800E51B8*);
void func_80711414(void);
Gfx* func_80711698(Gfx* gfx);
bool func_80711AC0(unk_800E51B8*, s32);
...
s32 Mfs_ChangeFileInDirAttr(u16, u8*, s32, s32, s32, s32);
s32 Mfs_GetFileInDirAttr(u16, u8*, u8*);
void func_80767940(void);
void func_80767FE4(s32, u8, u8*);
void func_8076805C(void);
void func_807680EC(u16, u8*, u8*, void*, s32, s32, s32, s32);
void func_8076814C(u16, u8*, u8*, void*, s32, s32, s32, s32);
void func_807681C8(u16, u8*, u8*, void*, s32, s32, s32, s32);
void func_80768244(u16, u8*, u8*, void*, s32, s32, s32, s32);
void func_807682C0(u16, u8*, u8*, void*, s32, s32, s32, s32);
void func_8076833C(u16, u8*, u8*, void*, s32, s32, s32, s32);
void func_807683B8(u16, u8*, u8*, void*, s32, s32, s32, s32);
void func_80768434(u16, u8*, u8*, void*, s32, s32, s32, s32);
void func_807684AC(u16, u8*, u8*, void*, s32, s32);
void func_8076852C(u16, u8*, u8*, void*, s32);
void func_80768574(u16, u8*, u8*, void*, s32);
void func_807685D8(u16, u8*, u8*, void*, s32);
void func_80768638(u16, u8*, u8*, void*, s32);
void func_8076869C(u16, u8*, u8*);
void func_8076870C(u16, u8*, u8*);
void func_8076877C(u8, u8*);
void func_807687E0(u8, u8*);
void func_80768844(u16, u8*, u8*, u8*, u8*, s32);
void func_807688D0(u16, u8*, u8*, s32);
void func_807689BC(u16, u8*, u8*, s32, s32, s32);
...
Gfx* func_i3_SetOptionColor(Gfx*, s32);
...
Gfx* func_i8_8009CA7C(Gfx*, s32, s32);
Gfx* func_i8_8009CC30(Gfx*, s32, s32);
void func_i8_8009CE64(void);
Gfx* func_i8_8009D0E8(Gfx*, s32, s32);
void func_i8_8009D430(void);
void func_i8_8009D5B8(s32);
Gfx* func_i8_8009D6A4(Gfx*, s32, s32);
void func_i8_8009D8A4(void);
Gfx* func_i8_8009D9D8(Gfx*, s32, s32);
void func_i8_8009DCC8(void);
void func_i8_8009DF6C(s32);
Gfx* func_i8_8009E0F0(Gfx*, s32, s32);
...
void func_xk1_80026908(s32);
void func_xk1_800269F4(unk_80026914*, s32*, s32*);
void func_xk1_800276B0(Gfx**, unk_80026914*, s32, s32);
void func_xk1_80027B74(unk_80026914*);
void func_xk1_80027CFC(unk_80026914*, s32*, s32*);
void func_xk1_80027DC8(unk_80026914*, s32*, s32*);
s32 func_xk1_800290C0(void);
void func_xk1_80029350(s32);
void func_xk1_800294AC(void);
void func_xk1_800294EC(void (*)(void));
void func_xk1_80029AB4(s32, s32);
Gfx* func_xk1_80029B48(Gfx*, s32, s32);
...
Gfx* func_xk1_8002FDF8(Gfx*, u16, u16, u16, u16, u8, u8, u8, u8, u8, u8);

void func_xk1_8002D16C(void);
s32 func_xk1_8002DAD4(void);
unk_80026914* func_xk1_80026914(unk_80026914*);
...
Gfx* func_xk3_8012F2F4(Gfx*, u16, u16, u16, u16, f32, f32, f32, f32, f32, f32);
...
Gfx* func_xk3_801352A4(Gfx*, s32, s32);
Gfx* func_xk3_80135C0C(Gfx*, s32, s32);
...
s32 func_xk3_80135850(unk_806F2400_unk_00*);
